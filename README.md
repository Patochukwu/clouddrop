...
* **Symptom**: Some files uploaded successfully, but others failed with: *"The request signature we calculated does not match the signature you provided."*
...
* **Symptom**: Express server crashed on startup on newer Node versions with: *"PathError: Missing parameter name at index 1: *"*
